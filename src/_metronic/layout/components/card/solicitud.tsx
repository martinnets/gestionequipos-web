...
const CardSolicitud: React.FC<SolicitudProps> = () => {
        ...
        <div className="card ">
            ...
            <div className="alert alert-info text-dark">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-2">
                        <p className="mb-2">
                            <strong>Dias Transcurridos:</strong><br />
                            <span className={`badge bg-danger fs-2x text-light text-center`}>
                                3
                            </span>
                        </p>
                    </div>
                    <div className="col-lg-2">
                        <p className="mb-2">
                            ...
                            <span className={`badge bg-success fs-2x text-light`}>
                                5
                            </span>
                        </p>
                    </div>
                ...
                <div className="row  ">
                    <div className="col-lg-12 mt-2">
                        <h5><i className="fa fa-microchip me-2"></i>CaracterÃ­sticas de la Gama</h5>
